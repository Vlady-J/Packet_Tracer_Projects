...
interface GigabitEthernet1/2
 description Inside Link to CORE-SW02 (      10.0.1.5/30      )
 nameif inside-0/2
 security-level 100
 ip address 10.0.1.5 255.255.255.252
!
interface GigabitEthernet1/3
 description Outside Link to EDGE-R1 (      10.0.0.2/30      )
 nameif outside-0/1
 security-level 0
 ip address 10.0.0.2 255.255.255.252
!
interface GigabitEthernet1/4
 description Inside Link to CORE-SW01 (      10.0.1.1/30      )
 nameif inside-0/1
 security-level 100
...
interface GigabitEthernet1/8
 description Outside Link to EDGE-R2 (      10.0.0.10/30      )
 nameif outside-0/2
 security-level 0
